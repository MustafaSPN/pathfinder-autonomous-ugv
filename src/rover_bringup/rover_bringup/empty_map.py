...
class EmptyMapPublisher(Node):
    ...
    def __init__(self):
        ...
        # 1000m (2000x2000=4M hucre) Pi'yi boguyordu: planner 0.65Hz, EKF/
        # controller update rate kaciriyordu. Harita zaten bos -> 100m yeter.
        # 100m = 200x200 = 40k hucre (100x daha hafif). +-50m calisma alani.
        self.map_size_m = 100.0

        # Grid Boyutu (Piksel cinsinden)
        self.grid_width = int(self.map_size_m / self.map_resolution)  # 200 piksel
        self.grid_height = int(self.map_size_m / self.map_resolution) # 200 piksel
