...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        remappings=[
            ('imu', '/gps/imu'),
            ('gps/fix', '/fix'),
            # KANONIK dual-EKF: navsat GLOBAL (map) ciktisini referans alir ki
            # /odometry/gps map frame'inde olsun. /odometry/local (odom) verilirse
            # GPS odom frame'inde cikar, map EKF'e geri beslenip runaway yapar.
